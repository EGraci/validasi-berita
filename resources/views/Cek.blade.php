    ...
    <div class="grid h-screen place-items-center">
        <div class="container mx-auto px-20">
            <div style='background-color:rgb(255, 255, 255)'>
                <form class="relative px-4 mx-auto max-w-7xl sm:px-6 lg:px-8" style="cursor: auto;" action="/cek" method="POST">
                    @csrf
                    <div class="max-w-lg mx-auto overflow-hidden rounded-lg shadow-lg lg:max-w-none lg:flex">
                        <div class="flex-1 px-6 py-8 bg-white lg:p-12" style="cursor: auto;">
                            <h3 class="text-2xl font-extrabold text-gray-900 sm:text-3xl" style="cursor: auto;">Berita Hoax</h3>
                            <p class="mt-6 text-base text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Beatae, perspiciatis.</p>
